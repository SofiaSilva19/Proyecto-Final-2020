...
int main()
{
    ...
    printf("El valor para h=%f hacia adelante es: %f, y su error realtivo del %f %% \n",h,DErivADelante(xi,h),Error1);
    printf("El valor para h=%f hacia atras es: %f, y su error relativo del %f %%\n",h,DErivaATras(xi,h),Error2);
    printf("El valor para h=%f centrada es: %f, y su error relativo del %f %%",h,DErivaCEntrada(xi,h),Error3);
}
float DErivADelante(float h, float(xi)){
